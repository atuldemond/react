...
function User() {
    return (
        ...
        <div className=" flex flex-col text-white">
         ...
         to="/users/Atul Demond">Atul Demond</Link>
         <Link className='p-3 bg-red-500 w-1/5  mb-3 mt-3 flex justify-center text-center font-extrabold ' 
            

         
         to="/users/Sumit Demond">Sumit Demond</Link>
         <Link 
         className='p-3 bg-red-500 w-1/5  mb-3 mt-3 flex justify-center text-center font-extrabold '
         
         
         to="/users/Rahul Kumar">Rahul Kumar</Link>
        
        </div>

        <button className='bg-yellow-300 p-2 mt-3 font-bold mb-5' >Explore More</button>
